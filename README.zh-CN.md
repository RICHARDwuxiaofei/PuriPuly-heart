...
使用服务商赠送的新人免费额度，**您可以免费使用相当长的一段时间**。

就算免费额度都用完了，每次说话（单次语音）也只会产生一点点费用。
...
*   *此资费标准截至：2026 年 2 月 8 日 / 开启快速响应模式*
*   *1 美元 ≈ 7.2 元人民币*
...
| **Qwen** | 每个模型 100万 Token | 90天 | 以新加坡主节点为准 |
...
3. 在 PuriPuly 的 **设置 (Settings)** 标签页中输入 API 密钥并验证。
   - 将 API 密钥粘贴到输入框后，请按回车键或取消聚焦输入框。
4. 确保在设置中选择：
   - STT: **Qwen ASR**
   - LLM: **Qwen 3.5 Plus**
   - Qwen 服务器区域 (Region): **Beijing** (如果您在百炼选择了北京)
5. 在 **仪表板 (Dashboard)** 中选择源语言/目标语言。
6. 点击 **STT** 和 **Trans** 按钮。
