...
| **DeepSeek V4 Flash** | 10,420 次 | 2,710 次 | 3,380 次 | 1,150 次 |
| **DeepSeek V4 Pro** | 3,380 次 | 1,760 次 | 2,020 次 | 930 次 |
...
| LLM \ ASR | Qwen ASR (本地) | Qwen ASR (云端) | Soniox | Deepgram |
|---|---|---|---|---|
| **Gemma 4 26B A4B** | ~0.001 元 | ~0.002 元 | ~0.002 元 | ~0.006 元 |
| **DeepSeek V4 Flash** | ~0.001 元 | ~0.003 元 | ~0.002 元 | ~0.006 元 |
| **DeepSeek V4 Pro** | ~0.002 元 | ~0.004 元 | ~0.004 元 | ~0.008 元 |
