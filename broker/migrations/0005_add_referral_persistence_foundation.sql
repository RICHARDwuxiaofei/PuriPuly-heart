ALTER TABLE discord_oauth_sessions
  ADD COLUMN referral_id TEXT CHECK (
    ...
    OR (
      ...
      AND referral_id GLOB '[23456789ABCDEFGHJKMNPQRSTUVWXYZ][23456789ABCDEFGHJKMNPQRSTUVWXYZ][23456789ABCDEFGHJKMNPQRSTUVWXYZ][23456789ABCDEFGHJKMNPQRSTUVWXYZ][23456789ABCDEFGHJKMNPQRSTUVWXYZ][23456789ABCDEFGHJKMNPQRSTUVWXYZ]'
    )
  );
