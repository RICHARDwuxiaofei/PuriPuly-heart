...
OPENROUTER_MODEL_GEMINI_25_FLASH_LITE = "google/gemini-2.5-flash-lite-preview"
...
OPENROUTER_FALLBACK_SELECTION_ALIAS_GEMINI25_FLASH_LITE = "gemini25_flash_lite"
...
FALLBACK_PROFILE_BY_ALIAS: dict[str, OpenRouterFallbackProfile] = {
    ...
    OPENROUTER_FALLBACK_SELECTION_ALIAS_GEMINI25_FLASH_LITE: OpenRouterFallbackProfile(
        alias=OPENROUTER_FALLBACK_SELECTION_ALIAS_GEMINI25_FLASH_LITE,
        label_key="provider.gemini25_flash_lite",
        description_key="provider.gemini25_flash_lite.description",
        openrouter_model=OPENROUTER_MODEL_GEMINI_25_FLASH_LITE,
    ),
...
LEGACY_FALLBACK_ALIAS_TO_ALIAS: dict[str, str] = {
    LEGACY_OPENROUTER_FALLBACK_SELECTION_ALIAS_GEMINI31_FLASH_LITE: OPENROUTER_FALLBACK_SELECTION_ALIAS_GEMINI25_FLASH_LITE,
    LEGACY_OPENROUTER_FALLBACK_SELECTION_ALIAS_GEMMA4: OPENROUTER_FALLBACK_SELECTION_ALIAS_GEMINI25_FLASH_LITE,
    OPENROUTER_SELECTION_ALIAS_GEMMA4_MANAGED: OPENROUTER_FALLBACK_SELECTION_ALIAS_GEMINI25_FLASH_LITE,
    OPENROUTER_SELECTION_ALIAS_GEMMA4_BYOK: OPENROUTER_FALLBACK_SELECTION_ALIAS_GEMINI25_FLASH_LITE,
